...
def telemetry(sid, data):
    file_directory = "/Users/hemanth/Udacity/behavioralData/"
    if data:
        ...
        '''
        if(count<1):
            save_image(image_array,file_directory,name='drive_trim_image.png')
            '''
        '''
        if(count<1):
            save_image(image_array,file_directory,name='drive_read_image.png')
            '''
        #image_array = Change_color(image_array)
        '''
        if(count<1):
            save_image(image_array,file_directory,name='drive_colorchange_image.png')
            #cv2.imwrite(file_directory+'color_change.png',image_array)
            '''
        image_array = preprocessing(image_array)
        '''
        if(count<1):
            save_image(image_array,file_directory,name='drive_resize_image.png')
            #cv2.imwrite(file_directory+'resize.png',image_array)
            count+=1
            '''
