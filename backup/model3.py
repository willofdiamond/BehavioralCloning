...
'''
model.add(Conv2D(25,5,2,activation='elu',W_regularizer = l2(0.001) ))
# Feature map 24@43x158
#model.add(Activation('relu'))
# Feature map 24@43x158
# Convolution layer 2
model.add(Conv2D(34,5,2,activation='elu',W_regularizer = l2(0.001)))

model.add(Conv2D(46,5,2,activation='elu',W_regularizer = l2(0.001)))

model.add(Conv2D(64,3,2,activation='elu',W_regularizer  = l2(0.001)))
...
model.add(Dense(200,activation= 'elu',W_regularizer  = l2(0.001)))
#model.add(Activation('elu'))
model.add(Dropout(0.4))
model.add(Dense(150,activation= 'elu',W_regularizer  = l2(0.001)))
#model.add(Dropout(0.4))
...
model.add(Conv2D(24, 5, 2, padding='valid', W_regularizer=l2(0.001),activation='elu')))
#model.add(ELU())
model.add(Convolution2D(36, 5, 2,  padding='valid', W_regularizer=l2(0.001),activation='elu')))
#model.add(ELU())
model.add(Convolution2D(48, 5, 2, padding='valid', W_regularizer=l2(0.001),activation='elu')))
#model.add(ELU())

#model.add(Dropout(0.50))

# Add two 3x3 convolution layers (output depth 64, and 64)
model.add(Convolution2D(64, 3, 3, padding='valid', W_regularizer=l2(0.001),activation='elu')))
...
model.save('model3_dataset_25.h5')
print('model saved')
